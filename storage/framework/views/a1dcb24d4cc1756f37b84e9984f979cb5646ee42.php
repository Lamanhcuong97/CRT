        ...
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
          ...
          $i = 1;
           ?>
            ...
            <?php if(isset($ctrshow_rp)): ?>
                <?php $__currentLoopData = $ctrshow_rp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctrshow_rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td class="center"><?php echo e($i); ?></td>
        						<td><?php echo e(date('d-m-Y H:i', strtotime($ctrshow_rp->upload_date))); ?></td>
        						<td><?php echo e(date('m-Y', strtotime($ctrshow_rp->ctr_month))); ?></td>
                    <!-- <td><?php echo e($ctrshow_rp->title); ?></td> -->
                    <td><?php if($ctrshow_rp->title !== null): ?> <?php echo e($ctrshow_rp->title); ?> <?php else: ?> <?php echo e('ລາຍງານ CTR '); ?> <?php endif; ?></td>
                    <td><a href="<?php echo e($ctrshow_rp->path_file); ?>" class="badge badge-primary">ດາວໂຫຼດ</a></td>
                    
                    <td><?php if($ctrshow_rp->path_person !== null): ?> <a href='<?php echo e($ctrshow_rp->path_person); ?>' class="badge badge-primary">ດາວໂຫຼດ</a>  <?php else: ?> <?php echo e('ລວມຢູ່ໃນໄຟລຫນ້າປົກ'); ?> <?php endif; ?></td>
                    <td><?php if($ctrshow_rp->path_legal !== null): ?> <a href='<?php echo e($ctrshow_rp->path_legal); ?>' class="badge badge-primary">ດາວໂຫຼດ</a> <?php else: ?> <?php echo e('ລວມຢູ່ໃນໄຟລຫນ້າປົກ'); ?> <?php endif; ?></td>
...
<?php echo $__env->make('layouts.main_ctrall_rp', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>