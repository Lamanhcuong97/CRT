            ...
            <div class="container">
                ...
                <div class="navbar-buttons navbar-header pull-right" role="navigation" >
                    <ul class="nav ace-nav">
                      ...
                      <li class="blue dropdown-modal">
          							<a class="dropdown-toggle" href="<?php echo e(url('/ctrpersonstats')); ?>">
          								<!-- <i class="ace-icon fa fa-tasks"></i> -->
                          ຂໍ້ມູນ CTR ບຸກຄົນ
          							</a>
          						</li>
                      ...
                      <li class="blue dropdown-modal">
          							<a class="dropdown-toggle" href="<?php echo e(url('/ctrlegalstats')); ?>">
          								<!-- <i class="ace-icon fa fa-tasks"></i> -->
                          ຂໍ້ມູນ CTR ນິຕິບຸກຄົນ
          							</a>
          						</li>

                      <li class="blue dropdown-modal">
          							<a class="dropdown-toggle" href="<?php echo e(url('/ctrsearch')); ?>">
          								<!-- <i class="ace-icon fa fa-tasks"></i> -->
                          ສະຖິຕິ CTR
          							</a>
          						</li>
