...
<form  class="form-horizontal" method="POST" action=<?php echo e(url('/strstore_ent')); ?> role="form" enctype="multipart/form-data" accept-charset="UTF-8">
<?php echo e(csrf_field()); ?>

  <div class="row">
  	<div class="widget-box animated fadeInRight">
  		<div class="widget-header">
  			<h4 class="widget-title text-lo" style="color: #426f8c;">ແບບພິມລາຍງານ ນິຕິບຸກຄົນ</h4>
  		</div>
...
<div id="accordion" class="accordion-style1 panel-group text-lo">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <div>
                ...
                <?php $__currentLoopData = $reportertypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reportertype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($reportertype->idreporter_type); ?>"><?php echo e($reportertype->reporter_type_title); ?></option>
          ...
          <div class="col-sm-8">
            <div>
                ...
                <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option value="<?php echo e($province->idprovince); ?>"><?php echo e($province->province_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 23. ຊື່: (*) </label>
          <div class="col-sm-8">
            <input type="text" name="entities_name" class="col-xs-12 col-sm-12" required/>
          </div>
        </div>

        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red" style = "color:red"> 24. ຮູບແບບທາງທຸລະກິດ: (*)</label>
          <div class="col-sm-8">
            <input type="text" name="entities_business_type" class="col-xs-12 col-sm-12" required/>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" name="entities_office_addr_detail" class="col-xs-12 col-sm-12" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <div class="col-sm-4">
              <div>
  							<select class="form-control province1" id="form-field-select-1" >
            ...
            <div class="col-sm-4">
              <div>
  							<select class="form-control district1" id="form-field-select-1" >
            ...
            <div class="col-sm-4">
              <div>
  							<select class="form-control village1" name="entities_office_addr" id="form-field-select-1" >
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="dob" style = "color:red"> 26. ວັນທີ່ອະນຸຍາດໃຫ້ດຳເນີນທຸລະກິດ: (*)</label>
          <div class="col-sm-2" id="dob">
              <div class="input-medium">
                  <div class="input-group clearfix text-lo">
                      <input class="input-medium date-picker" name="entities_business_approve_date"  type="text" data-date-format="yyyy-mm-dd" placeholder="ປປປປ-ດດ-ວວ" tabindex="" required/>
                      <span class="input-group-addon">
                          <i class="ace-icon fa fa-calendar"></i>
                      </span>
                  </div>
          ...
          <div class="col-sm-2">
            ...
            <div class="col-sm-12">
              <input type="text" name="entities_registra_capital" class="col-xs-12 col-sm-12" />
            </div>
          </div>
          ...
          <div class="col-sm-2">
            ...
            <div class="col-sm-12">
              <div>
                <select class="form-control" name="entities_registra_capital_currency" id="form-field-select-1" >
                  <option value="">ສະກຸນເງິນ</option>
                  <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($currency->idcurrency); ?>"><?php echo e($currency->currency_ini_l); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
              </div>
            </div>
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 28. ປະເພດການເຄື່ອນໄຫວ ອີງຕາມໃບທະບຽນວິສາຫະກິດ: (*)</label>
          <div class="col-sm-8">
            <input type="text" name="entities_business_registration_certificate_type" class="col-xs-12 col-sm-12" required/>
          </div>
        </div>

        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 29. ເລກທະບຽນວິສາຫະກິດ: (*)</label>
          <div class="col-sm-2">
            <input type="text" name="entities_business_registration_certificate_no" class="col-xs-12 col-sm-12" required/>
          </div>
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 30. ວັນທີ ແລະ ສະຖານທີ່ລົງທະບຽນ </label>
          <div class="col-sm-3">
            <input type="text" name="entities_business_registration_certificate_issue" class="col-xs-12 col-sm-12" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="entities_taxpayer_no" class="col-xs-12 col-sm-12" />
          </div>
          <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 32. ປະເພດ: </label>
          <div class="col-sm-3">
            <input type="text" name="entities_type" class="col-xs-12 col-sm-12" />
          </div>
        </div>

        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 33. ເລກລະຫັດ: </label>
          <div class="col-sm-8">
            <input type="text" name="entities_code" class="col-xs-12 col-sm-12" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <input type="text" name="entities_phone" class="col-xs-12 col-sm-12" />
          </div>
          <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> ເບີໂທຫ້ອງການ: </label>
          <div class="col-sm-2">
            <input type="text" name="entities_tel" class="col-xs-12 col-sm-12" />
          </div>
          <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> ເບີໂທລະສັບມືຖື: </label>
          <div class="col-sm-2">
            <input type="text" name="entities_cell" class="col-xs-12 col-sm-12" />
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 35. ຊື່ ແລະ ນາມສະກຸນ: (*)</label>
          <div class="col-sm-3">
            <input type="text" name="personnel_name_e" class="col-xs-12 col-sm-12" required/>
          </div>
          <label class="col-sm-2 control-label no-padding-right" for="form-field-1" style = "color:red"> 36. ສັນຊາດ: (*)</label>
          <div class="col-sm-3">
            <div>
                ...
                <option value="<?php echo e($nationality->idnationality); ?>"><?php echo e($nationality->nationality_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 37. ເພດ: (*)</label>
          <div class="col-sm-3">
						<label class="inline">
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 39. ອາຊີບ: (*)</label>
          <div class="col-sm-8">
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 40. ສາຍພົວພັນກັບນິຕິບຸກຄົນ: (*) </label>
          <div class="col-sm-8">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" name="beneficiary_name" class="col-xs-12 col-sm-12" requiredrequired required/>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <div>
							<select class="form-control" name="beneficiary_nationality" id="form-field-select-1" requiredrequired required>
								<option value="">ສັນຊາດ</option>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="acc_no_or_insurance" class="col-xs-12 col-sm-12" required required/>
          </div>
          <label class="col-sm-3 control-label no-padding-right" for="form-field-1" style = "color:red"> 56. ປະເພດ ບັນຊີ: (*)</label>
          <div class="col-sm-2">
            <input type="text" name="acc_type" class="col-xs-12 col-sm-12" required required/>
          </div>
        </div>
        ...
        <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-comment">ເອກະສານຕິດຄັດບໍ່ເກີນ 20MB</label>
					<div class="col-sm-8">
