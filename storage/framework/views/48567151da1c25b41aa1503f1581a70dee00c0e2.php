...
<div style="padding-top: 55px;"></div>
    ...
    jQuery(function($) {
      ...
      // $(document).ready(function() {
        $('.datepicker').datepicker({
          ...
          // todayHighlight: true,
          // language: 'la',
          autoclose: true, startDate: '01-01-2008', todayBtn: "linked", calendarWeeks: true, keyboardNavigation: false, forceParse: false
        });
      // });
      ////////////////////////////////////
      ////////////////////////////////////
    ...
    $(".bt_amliostrno").click(function(){
    $(this).attr('data-id');
    $("#form_id2").val($(this).attr('data-id'));
    });
