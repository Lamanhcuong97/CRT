...
<div class="space-5"></div>
  ...
  <div class="widget-box">
      ...
      <h3 style="font-family:Phetsarath OT;" class="bg-primary text-center">ສະຖິຕິ CTR ບຸກຄົນ ມີທັງຫມົດ <?php echo e(number_format($p_all_trans)); ?> ທຸລະກຳ ນັບແຕ່ <?php echo e(date('m/Y', strtotime($from_date)).' ຫາ '.date('m/Y', strtotime($to_date))); ?></h3>
...
<h3 style="font-family:Phetsarath OT;" class="bg-primary text-center">ສະຖິຕິ CTR ນິຕິບຸກຄົນ ມີທັງຫມົດ <?php echo e(number_format($l_all_trans)); ?> ທຸລະກຳ ນັບແຕ່ <?php echo e(date('m/Y', strtotime($from_date)).' ຫາ '.date('m/Y', strtotime($to_date))); ?></h3>
