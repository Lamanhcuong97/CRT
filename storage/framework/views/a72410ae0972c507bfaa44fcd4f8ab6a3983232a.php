...
<div class="row">
  ...
  <form  class="form-horizontal" method="POST" action=<?php echo e(url('/commentshow')); ?> role="form" enctype="multipart/form-data" accept-charset="UTF-8">
        ...
        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
          ...
          $i = 1;
           ?>
            ...
            <?php if(isset($commentreports)): ?>
                <?php $__currentLoopData = $commentreports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commentreport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td class="center"><?php echo e($i); ?></td>
        						<td><?php echo e($commentreport->comment_form_date); ?></td>
                    <td><?php echo e($commentreport->comment_form_detail); ?></td>
                    <td><?php echo e($commentreport->username); ?></td>
...
<?php echo $__env->make('layouts.main1', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>