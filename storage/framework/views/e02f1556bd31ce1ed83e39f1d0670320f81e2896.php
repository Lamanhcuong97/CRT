...
<form  class="form-horizontal" method="POST" action=<?php echo e(route('reply-report')); ?> role="form" enctype="multipart/form-data" accept-charset="UTF-8">
...
<input type="hidden" name="report_id" value=<?php echo e($report_id); ?>>
<!-- 
