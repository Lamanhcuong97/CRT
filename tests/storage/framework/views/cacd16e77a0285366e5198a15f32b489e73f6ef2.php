...
<html>
  <head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link href="<?php echo e(asset('ace-skins.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('ace-rtl.min.css')); ?>" rel="stylesheet" />
          										...
          										<li>
          											<a href="{{ url('/firviews')}}">
          												<div class="clearfix">
          													...
          													<span class="pull-left" style="margin-top: -3px; margin-bottom: -3px;"><strong><i class="fa fa-user-secret"></i>&nbsp;ລາຍງານ FIR</strong></span>
          												</div>
          											</a>
          										</li>
                              ...
                              <li>
          											<a href="{{ url('/strdetails')}}">
          												<div class="clearfix">
          													...
          													<span class="pull-left" style="margin-top: -3px; margin-bottom: -3px;"><strong><i class="fa fa-file-text-o"></i>&nbsp;ລາຍງານທຸລະກຳ</strong></span>
          												</div>
          											</a>
          										</li>
                              ...
                              <!-- <li>
          											<a href="/strreporters">
          												<div class="clearfix">
          													...
          													<span class="pull-left" style="margin-top: -3px; margin-bottom: -3px;"><strong><i class="fa fa-bank"></i>&nbsp;ລາຍງານ ຕາມບັນດາທະນາຄານ</strong></span>
          												</div>
          											</a>
          										</li>
                              ...
                              <li>
          											<a href="/strbranchs">
          												<div class="clearfix">
          													...
          													<span class="pull-left" style="margin-top: -3px; margin-bottom: -3px;"><strong><i class="fa fa-sitemap"></i>&nbsp;ລາຍງານ ຕາມສາຂາທະນາຄານ</strong></span>
          												</div>
          											</a>
          										</li> -->
                              ...
                              <li>
          											<a href="{{ url('/nat')}}">
          												<div class="clearfix">
          													...
          													<span class="pull-left" style="margin-top: -3px; margin-bottom: -3px;"><strong><i class="fa fa-globe"></i>&nbsp;ລາຍງານ ຕາມສັນຊາດ</strong></span>
          												</div>
          											</a>
          										</li>
                              ...
                              <li>
          											<a href="{{ url('/strcharts')}}">
          												<div class="clearfix">
          													...
          													<span class="pull-left" style="margin-top: -3px; margin-bottom: -3px;"><strong><i class="fa fa-pie-chart"></i>&nbsp;ສະຖິຕິ ຮູບກຣາບ</strong></span>
          												</div>
          											</a>
          										</li>
