                ...
                <?php $__currentLoopData = $stralls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $strall => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <?php if($name->str_stt !== '0'): ?>
          						<td><a href="<?php echo e(url('strreceive/' . $name->idstr_form)); ?>" style="color: purple;"><?php if($name->str_form_reporter_name !== null): ?> <?php echo e($idsenders[$name->reporter_idusr]); ?> <?php else: ?> <?php echo e('ບໍ່ມີຂໍ້ມູນ'); ?> <?php endif; ?></a></td>
                    <?php else: ?>
