                ...
                @foreach($ctrshow_rp as $ctrshow_rp)
                  <tr>
                    <td class="center">{{$i }}</td>
        						<td>{{ date('d-m-Y H:i', strtotime($ctrshow_rp->upload_date)) }}</td>
        						<td>{{ date('m-Y', strtotime($ctrshow_rp->ctr_month)) }}</td>
                    <!-- <td>{{ $ctrshow_rp->title }}</td> -->
                    <td>@if($ctrshow_rp->title !== null) {{ $ctrshow_rp->title }} @else {{ 'ລາຍງານ CTR ' }} @endif</td>
                    <td><a href="{{ $ctrshow_rp->path_file }}" class="badge badge-primary">ດາວໂຫຼດ</a></td>
                    
                    <td>@if($ctrshow_rp->path_person !== null) <a href='{{ $ctrshow_rp->path_person }}' class="badge badge-primary">ດາວໂຫຼດ</a>  @else {{ 'ລວມຢູ່ໃນໄຟລຫນ້າປົກ' }} @endif</td>
                    <td>@if($ctrshow_rp->path_legal !== null) <a href='{{ $ctrshow_rp->path_legal }}' class="badge badge-primary">ດາວໂຫຼດ</a> @else {{ 'ລວມຢູ່ໃນໄຟລຫນ້າປົກ' }} @endif</td>
